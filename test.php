<?php
 ...
 $con = mysqli_connect("localhost","root","","tuongee");
...
function getbrands(){
    ...
    echo "<li class=even><a href='variety.php?brand=$brand_id'>$brand_title</a></li>"; 
...
function details(){
    ...
    echo"
        ...
        <div class='product_img_big'> <a href='javascript:popImage('images/$product_image','Some Title')' title='header=[<img src=images/$product_image>] body=[&nbsp;] fade=[on]'><img src='images/$product_image' height=200 width=185 alt='' border='0' /></a>
        </div>
